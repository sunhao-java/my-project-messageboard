...
var _156=$("<div class=\"panel-header\"><div id='111' class=\"panel-title\">"+opts.title+"</div></div>").prependTo(_155);
if(opts.iconCls){
...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:10000,draggable:true,resizable:true,shadow:true,modal:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _1ae(_1af){
var t=$(_1af);
