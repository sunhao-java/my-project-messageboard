        ...
        */
        _createResize: function() {
            ...
            this._resize = new YAHOO.util.Resize(this._resizeEl, {
                ...
                /**
                 * 控制哪些方向出现可以移动的方框
                 * l(eft)左r(ight)右t(op)上b(uttom)下
                 * 角用上面四个的组合
                 */
                handles: this.get('handles'),
                /**
                 * 是否可以移动
                 */
                draggable: true,
                /**
                 * 用来决定右下角输出当前resize区域的大小和坐标
                 */
        ...
        */      
        ...
        initAttributes: function(attr) {
            ...
            */
            ...
            /**
             * @attribute handles
             * @description set the resize area handles, defaults is all of 8 boxes
             * @type array
             * @adder sunhao(sunhao.java@gmail.com)
             * @time 2012-03-23 18:20
             */
