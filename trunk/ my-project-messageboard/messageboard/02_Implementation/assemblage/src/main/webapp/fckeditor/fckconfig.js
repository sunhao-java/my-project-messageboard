...
/**
 * if you want to create some style what you want.
 * you can config here like the template under:
 * template: 'Red Title':{Element : 'h3', Styles : {'color': 'Red'}}
 *
 * or you can config in file:fckstyles.xml(/fckeditor/fckstyles.xml)
 */
