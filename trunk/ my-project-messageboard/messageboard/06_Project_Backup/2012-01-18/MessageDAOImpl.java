	...
	public PaginationSupport getAllMessages(int start, int num, Message message)
		...
		if(message != null){
			...
			if(message.getCreateUser() != null && StringUtils.isNotEmpty(message.getCreateUser().getTruename())){
				hql += " and createUsername like :truename";
				countHql += " and createUsername like :truename";
				params.put("truename", SqlUtils.makeLikeString(StringUtils.trim(message.getCreateUser().getTruename())));
			}
		}
